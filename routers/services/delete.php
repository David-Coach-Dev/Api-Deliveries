      ...
      if(isset($_GET["id"]) && isset($_GET["nameId"])){
         ...
         ********************************************/
          ...
          if (empty(Connection::getColumnsData($db, $table, $columns))){
            $return -> fncResponse(400, "Delete", array("error"=>"Tabla o Columna invalida..."));
            return;
          }
        /***********************************************************************************
            ...
            if(isset($_GET["token"])){
               ...
               ***********************************************************************************/
                if($validate=="ok"){
                   ...
                   ***********************************************************************************/
                    if($validate=="exp"){
                        $return->fncResponse(403, "DELETE", array("error"=>"El token a expirado..."));
                    }
                  /***********************************************************************************
                   *? No-out -> si el token no coincide en DB.
                   ***********************************************************************************/
                    if($validate=="no-aut"){
                        $return->fncResponse(403, "DELETE", array("error"=>"El usuario no esta autorizado...."));
                    }
                }else{
                  /***********************************************************************************
                   *? No consta con un token de autorización.
                   ***********************************************************************************/
                      $return->fncResponse(403, "DELETE", array("error"=>"Autorización requerida...."));
            }
    }
      }
?>