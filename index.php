<?php
   ...
   *******************************/
    ...
    header("Access-Control-Allow-Headers: Origin, Authorization, X-Requested-With, Content-Type: application/json; application/x-www-form-urlencoded; charset=utf-8;, Accept");
